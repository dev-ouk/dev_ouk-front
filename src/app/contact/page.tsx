    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-6">Contact</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            프로젝트 협업, 기술 문의, 또는 단순한 인사까지 언제든 환영합니다
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">연락처 정보</h2>
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">@dev_ouk</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">일상과 개발 이야기를 공유합니다</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">협업 가능한 분야</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">메시지 보내기</h2>
